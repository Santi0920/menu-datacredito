...
<form action="{{route('crud.create')}}" class="col 3 m-3" method="POST" enctype= "multipart/form-data" onsubmit="return validateForm()">
  <h2 class="p-2 text-secondary text-center"><b>Datacrédito Asociación</b></h2>
...
<div class="mb-3 w-100" title="Este campo es obligatorio">
  ...
  <input type="date" class="form-control " name="FechaInsercion" id="FechaInsercion" min="2022-05-01" max="<?php echo date('Y-m-d'); ?>" required>
</div>
...
.formato-ayuda2 {
  ...
  <div class="mb-3 w-100">
    ...
    <p class="formato-ayuda2">Formato: <strong>T1-(Cédula).pdf o T2-(Cédula).pdf</strong></p>
  </div>
...
consecutivofInput.setAttribute("maxlength", "6");
        ...
        <table id="personas" class="hover table table-striped shadow-lg mt-4 table-bordered table-hover col-md-5">
          <thead class="" style="background-color: #005E56;">
            <tr class="text-white">
              ...
              <th class="" scope="col">IDA</th>
              <th class="" scope="col">MONTO</th>
              <th class="" scope="col">DEUDAESP</th>
    ...
    var consecutivofError2 = document.getElementById('consecutivofError3');

    if (!/^[0-9]+$|^N\/A$/i.test(consecutivofInput.value)) {
      Swal.fire({
        icon: 'error',
        title: '¡Error!',
        text: 'El campo CONSECUTIVO FORMATO debe contener solo numéros O N/A!',
        confirmButtonColor: '#005E56'
      });
      window.scrollTo({ top: 0, behavior: 'smooth' });
      consecutivofError2.innerHTML = 'Ingrese solo números o N/A!';
      return false;
    }
    var consecutivoaInput = document.getElementById('consecutivoa');
    var consecutivoaError2 = document.getElementById('analisisError3');

    if (!/^[0-9]+$|^N\/A$/i.test(consecutivoaInput.value)) {
      Swal.fire({
        icon: 'error',
        title: '¡Error!',
        text: 'El campo CONSECUTIVO ANÁLISIS debe contener solo numéros o N/A!',
        confirmButtonColor: '#005E56'
      });
      window.scrollTo({ top: 0, behavior: 'smooth' });
      consecutivoaError2.innerHTML = 'Ingrese solo números o N/A!';
      return false;
    }
    var montoInput = document.getElementById('monto');
    var montoError2 = document.getElementById('montoError3');

    if (!/^[0-9]+$/.test(montoInput.value)) {
      Swal.fire({
        icon: 'error',
        title: '¡Error!',
        text: 'El campo MONTO debe contener solo numéros!',
        confirmButtonColor: '#005E56'
      });
      window.scrollTo({ top: 0, behavior: 'smooth' });
      montoError2.innerHTML = 'Ingrese solo números!';
      return false;
    }

    var deudaInput = document.getElementById('deudaesp');
    var deudaError2 = document.getElementById('deudaError3');

    if (!/^[0-9]+$/.test(deudaInput.value)) {
      Swal.fire({
        icon: 'error',
        title: '¡Error!',
        text: 'El campo DEUDA ESPECIAL debe contener solo numéros!',
        confirmButtonColor: '#005E56'
      });
      window.scrollTo({ top: 0, behavior: 'smooth' });
      deudaError2.innerHTML = 'Ingrese solo números!';
      return false;
    }
 ...
 var table = $('#personas').DataTable({
  ...
  render: function(data, type, row) {
    ...
    {    data: null,
      ...
      var editButton = `<a href="" id="modalLink" type="submit" class="btn btn-small btn-warning edit-button edit" data-bs-toggle="modal" data-bs-target="#modalEditar" data-id="${id}" style="margin-right: "><i class="fa-regular fa-pen-to-square"></i></a>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="cedula2" id="cedula2" readonly value="" style="background-color: #EBEBEB; cursor: not-allowed;">
                <input type="hidden" name="cedula3"  value="">
              </div>

              <div class="mb-3">
                <label for="nombre3" id="izquierda3" class="form-label fw-bold">NOMBRE</label>
                <input type="text" class="form-control" id="nombre3" name="nombre3" value="" maxlength="30" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="apellidos3" name="apellidos3" value="" maxlength="60" oninput="this.value = this.value.toUpperCase()" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="score3" name="score3" value="" maxlength="3" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="reporte3" name="reporte3" maxlength="15" value="" oninput="this.value = this.value.toUpperCase()">
              ...
              <div class="mb-3 ">
                  ...
                  <input type="text" class="form-control" name="cuenta3" id="cuenta3" readonly value="" style="background-color: #EBEBEB; cursor: not-allowed;">
              ...
              <div class="mb-3">
                  ...
                  <input list="agencia" type="text" class="form-control" id="agencia3" name="agencia3" value="" maxlength="20" required autocomplete="off">
              ...
              <div class="mb-3">
                  ...
                  <input type="date" class="form-control" name="fecha3" id="fecha3" min="2022-08-01" max="`+today+`" value="" required>
                </div>
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="consecutivof33" id="consecutivof33" value="" oninput="" onkeyup="this.value = this.value.toUpperCase();">
                  <div id="consecutivofError3" style="color: red;" class="fw-bold"></div>
                  </div>

                  <div class="mb-3 w-100">
                      <label for="tipo" class="form-label fw-bold" id="izquierda16">TIPO FORMATO</label>
                      <select class="form-control" name="tipof3" id="tipof3" required oninput="validarCampos()">
                        <option value="">Seleccione una opción</option>
                        <option value="N/A">N/A</option>
                        <option value="T1">Formato T1</option>
                        <option value="T2">Formato T2</option>
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" id="izquierda15" class="form-label fw-bold">ADJUNTAR ANÁLISIS</label>
                <input type="file" class="form-control" name="archivo55" id="archivo55" accept="application/pdf" value="">
              </div>

              <div class="mb-3">
                <label for="nombre3" id="izquierda14" class="form-label fw-bold">CONSECUTIVO ANÁLISIS</label>
                <input type="text" class="form-control" id="consecutivoa" name="consecutivoa" value="" onkeyup="this.value = this.value.toUpperCase();">
                <div id="analisisError3" style="color: red;" class="fw-bold"></div>
              </div>

              <div class="mb-3">
                <label for="nombre3" id="izquierda13" class="form-label fw-bold">MONTO</label>
                <input type="text" class="form-control" id="monto" name="monto" value="">
                <div id="montoError3" style="color: red;" class="fw-bold"></div>
              </div>

              <div class="mb-3">
                <label for="nombre3" style="margin-left:-71%" class="form-label fw-bold">DEUDA ESPECIAL</label>
                <input type="text" class="form-control" id="deudaesp" name="deudaesp" value="">
                <div id="deudaError3" style="color: red;" class="fw-bold"></div>
              </div>
...
$('#personas').on('click', '.edit', function() {
  ...
  $("#consecutivof33").val(rowData["Consecutivof"]);
  $("#tipof3").val(rowData["Tipof"])
  $("#consecutivoa").val(rowData["ConsecutivoAnalisis"])
  $("#deudaesp").val(rowData["DeudaEsp"])
  $("#monto").val(rowData["Monto"]);
  $("#cedula2").val(rowData["Cedula"]);
  $("#nombre3").val(rowData["Nombre"]);
  $("#apellidos3").val(rowData["Apellidos"]);
  $("#score3").val(rowData["Score"]);
  $("#reporte3").val(rowData["Reporte"]);
  $("#cuenta3").val(rowData["CuentaAsociada"]);
  $("#agencia3").val(rowData["Agencia"]);
  $("#fecha3").val(rowData["FechaInsercion"]);
  $("#estado3").val(rowData["Estado"]);
  $("#archivo22").val(rowData["NombreS"]);
  $("#archivo11").val(rowData["NombrePN"]);
  $("#archivo33").val(rowData["NombreT"]);
