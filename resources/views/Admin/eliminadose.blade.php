  ...
  @csrf
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="mb-3 w-100">
          ...
          <div class="mb-3 w-100">
            <label for="agenciaU" class="form-label fw-bold" style="margin-left: -84%;">AGENCIA / ÁREA<span class="text-danger" style="font-size:20px;"></label>
    ...
    <form class="col 3 m-3" method="GET" enctype="multipart/form-data" action="{{ route('eliminar.total') }}">
        @csrf
        <h2 class="m-5"><b>Eliminación SOLO <span class="text-danger">Asociados, Crédito y Empleados</span></b></h2>
        ...
        <button onclick="return eliminar()" class="m-5 boton" type="submit" >Eliminar</button>
    </form>
</div>
        <script>
 ...
 var table = $('#personas').DataTable({
  ...
  render: function(data, type, row) {
    ...
    {    data: null,
      ...
      var deleteButton = '<a onclick="return eliminar2()" href="{{ route('crud.delete3', ':id') }}" type="submit" class="btn btn-small btn-danger" name="eliminar" value="ok"><i class="fa-solid fa-trash"></i></a>'.replace(':id', row.ID);
