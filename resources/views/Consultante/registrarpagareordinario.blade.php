...
<div class="container-fluid row p-4">
    <form action="{{ route('cruddir.createpagareordinario')}}" class="col m-3" method="POST" enctype= "multipart/form-data" id="pagare">
    @csrf 
    ...
    <div class="mb-3 w-100" title="Este campo es obligatorio">
        ...
        <input type="number" class="form-control " name="NoAgencia" id="input2" autocomplete="off" oninput="limitInputLength(this, 2)" required >
          <script>
      ...
      <div class="mb-3 w-100" title="Este campo es obligatorio">
        ...
        <input type="number" class="form-control " name="CuentaCoop" id="input3" autocomplete="off" required oninput="limitInputLength(this, 8)">
        
      </div>

      <div class="mb-3 w-100" title="Este campo es obligatorio">
        <label for="input4" class="form-label fw-semibold">CÉDULA <span class="text-danger" style="font-size:20px;">*</span></label>
        <input type="number" class="form-control " name="Cedula_Persona" id="input4" autocomplete="off" required oninput="limitInputLength(this, 12)">
        
      </div>

      <div class="mb-3 w-100" title="Este campo es obligatorio">
        <label for="input5" class="form-label fw-semibold">NOMBRE COMPLETO <span class="text-danger" style="font-size:20px;">*</span></label>
        <input type="text" class="form-control " name="NombreCompleto" id="input5" autocomplete="off" required oninput="limitInputLength(this, 40)">
      ...
      <div class="mb-3 w-100" title="Este campo es obligatorio">
        ...
        <input type="number" class="form-control " name="Capital" id="input8" autocomplete="off" required oninput="limitInputLength(this, 20)">
        
      </div>

      <div class="mb-3 w-100" title="Este campo es obligatorio">
        <label for="input9" class="form-label fw-semibold">NÚMERO DE CUOTAS <span class="text-danger" style="font-size:20px;">*</span></label>
        <input type="number" class="form-control " name="NoCuotas" id="input9" autocomplete="off" required oninput="limitInputLength(this, 3)">
        
      </div>

      <div class="mb-3 w-100" title="Este campo es obligatorio">
        <label for="input10" class="form-label fw-semibold">VALOR CUOTA <span class="text-danger" style="font-size:20px;">*</span></label>
        <input type="number" class="form-control " name="ValorCuota" id="input10" autocomplete="off" required oninput="limitInputLength(this, 20)">
        
      </div>
      <div class="mb-3 w-100" title="Este campo es obligatorio">
    <label for="input11" class="form-label fw-semibold">TASA <span class="text-danger" style="font-size:20px;">*</span></label>
    <input type="text" class="form-control" name="Tasa" id="input11" autocomplete="off" required oninput="validateTasaInput(this); limitInputLength(this, 6)" onblur="formatTasa(this)">
...
<script>
    ...
    function limitInputLength(input, maxLength) {
      ...
      <div class="mb-3 w-100" title="Este campo es obligatorio">
        ...
        <input type="text" class="form-control " name="Direccion" id="input14" autocomplete="off" required oninput="limitInputLength(this, 100)">
        
      </div>

      <div class="mb-3 w-100" title="Este campo es obligatorio">
        <label for="input15" class="form-label fw-semibold">TELÉFONO FIJO <span class="text-danger" style="font-size:20px;">*</span></label>
        <input type="number" class="form-control " name="TelFijo" id="input15" autocomplete="off" required oninput="limitInputLength(this, 12)">
    ...
    <input type="number" class="form-control" name="Fecha1Cuota" id="input16" autocomplete="off" required oninput="validateFecha1Cuota(this)">
    <p class="formato-ayuda">Ejemplo: <strong>1240130</strong>. 124 - es el año, 01 - es el mes y 30 - es el día.</p>
...
<div class="mb-3 w-100" title="Este campo es obligatorio">
    ...
    <input type="number" class="form-control" name="FechaUltimaCuota" id="input17" autocomplete="off" required oninput="validateFechaUltimaCuota(this)">
    <p class="formato-ayuda">Ejemplo: <strong>1240130</strong>. 124 - es el año, 01 - es el mes y 30 - es el día.</p>
    <p id="errorFechaUltimaCuota" class="text-danger"></p>
      ...
      <div class="mb-3 w-100" title="Este campo es obligatorio">
        ...
        <input type="number" class="form-control " name="Celular" id="input18" autocomplete="off" required oninput="limitInputLength(this, 20)">
      ...
      <div class="mb-3 w-100" title="Este campo es obligatorio">
        <label for="input19" class="form-label fw-semibold">GARANTIA <span class="text-danger" style="font-size:20px;">*</span></label>
        <input type="text" class="form-control" name="Garantia" id="input19" autocomplete="off" required oninput="validarGarantia(this); limitInputLength(this, 6)">
      ...
      <div class="text-center">
          <button id="agregar" type="submit" class="btn btn-primary fs-4 fw-bold" name="btnregistrar" style="background-color: #005E56;" disabled>Registrar</button>
      </div>
...
function limpiarCampos() {
 ...
 var table = $('#personas').DataTable({
  "ajax": "{{ route('datatable.dirpagareordinario') }}",
  "order": [[0, 'desc']],
  "columns": [
    {
        data: 'ID',
