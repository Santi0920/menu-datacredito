...
<form action="{{route('crudc.createcredito')}}" class="col 3 m-3" method="POST" enctype= "multipart/form-data" onsubmit="return validateForm()">
...
.formato-ayuda2 {
  ...
  <div class="mb-3 w-100" title="Este campo es obligatorio">
    ...
    <input list="" type="text" class="form-control " name="CuentaAsociada" id="cuenta" required autocomplete="off"> 
...
<div class="mb-3 w-100">
    ...
    <p class="formato-ayuda2">Debe contener el formato: <strong>Autorizacion-(Cédula).pdf o Analisis-(Cédula).pdf</strong></strong></p>
  </div>
  ...
  <div class="mb-3 w-100" title="Este campo es obligatorio">
  <label for="exampleInputEmail1" class="form-label fw-semibold">CONSECUTIVO AUTORIZACIÓN o ANÁLISIS<span class="text-danger" style="font-size:20px;">*</span></label>
  <input type="text" class="form-control" name="consecutivoa" id="consecutivoa" value="" required autocomplete="off" maxlength="10">
...
<div class="mb-3 w-100" title="Este campo es obligatorio">
  <label for="exampleInputEmail1" class="form-label fw-semibold">CONSECUTIVO RECIBO DE CAJA <span class="text-danger" style="font-size:20px;">*</span></label>
  <input list="Consecutivo" type="text" class="form-control" name="ConsecutivoRC" id="ConsecutivoAnalisis" value="" required autocomplete="off" maxlength="10" pattern="[0-9]+|N/A" title="Debe ingresar solo números o 'N/A'">
  ...
  <input list="" type="text" class="form-control" name="ObRC" id="ConsecutivoAnalisis" value="" autocomplete="off" maxlength="200" >
  <div id="consecutivoAnalisisError" style="color: red;" class="fw-bold"></div>
  <div id="consecutivoAError2" style="color: red;" class="fw-bold"></div>
</div>
...
<div class="mb-3 w-100" title="Este campo es obligatorio">
  <label for="estado" class="form-label fw-semibold">LINEA DE CRÉDITO <span class="text-danger" style="font-size:20px;">*</span></label>
  ...
  <div class="mb-3 w-100" title="Este campo es obligatorio">
    <label for="exampleInputEmail1" class="form-label fw-semibold">MONTO <span class="text-danger" style="font-size:20px;">*</span></label>
    <input list="" type="text" class="form-control" name="Monto" id="Monto" value="" required autocomplete="off" maxlength="15">
  ...
  <div class="mb-3 w-100" title="Este campo es obligatorio">
    <label for="" class="form-label fw-semibold">INSPEKTOR <span class="text-danger" style="font-size:20px;">*</span></label>
    <input list="Consecutivo" autocomplete="off" type="text" class="form-control" name="Inspektor" id="Inspektor" required>
...
if(row.Consulta == 1){
  ...
  <div class="mb-3 w-100 text-start" title="Datacredito vencido!">
    ...
    <option value="N/A"></option>
      ...
      var deleteButton = '<a onclick="showUnauthorizedMessage()" href="#" type="" class="btn btn-small btn-danger" name="eliminar" value="ok"><i class="fa-solid fa-trash"></i></a>'.replace(':id', row.ID);
