...
<div>
    <h2 class="p-4 text-secondary"><b><span id="fechaActual">Consulta Asociaciones Virtuales</span></b></h2>
  </div>
        ...
        <table id="personas" class="hover table table-responsive table-striped shadow-lg mt-4 table-bordered table-hover"  style="width:100%" >
          <thead class="" style="background-color: #005E56;">
            <tr class="text-white">
              ...
              <th style="font-size: 1.8125rem; width: 5%;"><span style="font-size: 2.8125rem;">Fecha</span></th>
...
<script src="ResourcesAll/dtables/jquery-3.5.1.js"></script>
        ...
        <script>
          $(document).ready(function () {
              $('#personas').DataTable({
                  "ajax": "{{ route('datatable.avirtualdirector') }}",
                  "columns": [
                      { data: 'Cedula' },
                      {
                        data: 'FechaInsercion',
                        render: function (data, type, row) {
                            ...
                            if (parseInt(row.Consulta) === 1 && diferencia > 180) {
                                html += '<span class="fw-bold text-dark" style="font-size: 25px;">'+data + '</span><span class="text-danger fw-bold blink" style="font-size: 25px;"><br><span style="background-color: yellow;">RENOVAR</span></span>';
                            } else if (diferencia > 180) {
                                html += '<span class="fw-bold text-dark" style="font-size: 25px;">'+data + '</span><span class="text-danger fw-bold blink" style="font-size: 25px;"><br>VENCIDO</span>';
                            }else if (diferencia <= 175 && diferencia > 179) {
                                html += '<span class="fw-bold text-dark" style="font-size: 25px;">'+data + '</span><span class="text-danger fw-bold blink" style="font-size: 25px;"><br><span style="background-color: yellow;">Pronto a vencerse en ' + (diferencia + 1) + ' días</span>';
                            } else if (diferencia === 179) {
                                html += '<span class="fw-bold text-dark" style="font-size: 25px;">'+data + '</span><span class="text-danger fw-bold blink" style="font-size: 25px;"><br><span style="background-color: yellow;">Se vence en 2 dias</span>';
                            } else if (diferencia === 180) {
                                html += '<span class="fw-bold text-dark" style="font-size: 25px;">'+data + '</span><span class="text-danger fw-bold blink" style="font-size: 25px;"><br><span style="background-color: yellow;">¡Se vence mañana!</span>';
                            } else {
                                html += '<span class="fw-bold text-dark" style="font-size: 25px;">'+data + '</span><span class="fw-bold" style="color: #1565c0; font-size: 25px;"><br>Al día</span>';
                            }
                            ...
                            return '<td style="font-size: 2.8125rem; position: relative;" class="fw-semibold">' +
                                ...
                                '</a>' +
                                '<br>' +
                                '<embed id="pdfEmbed" src="' + embedSrc + '" frameborder="0" width="1000" height="590" style="margin-left: 565px; margin-top: -90px; position: absolute; top: 0;">' +
                                '</td>';
                        }
                        },
                        {
