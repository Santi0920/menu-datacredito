                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (row.ExisteDatacredito == 2) {
                            var AprobadoButton =
                                '<span class="text-danger blink" style="font-weight: bold; font-size: 25px">SCORE NULO</span><br><span class="text-dark opacity-50" style="font-weight: bold; font-size: 15px">Espere a area de cumplimiento a que sea consultado.</span>';
                        } else if (row.ExisteDatacredito == 3) {
                            var AprobadoButton =
                                '<span class="text-danger blink" style="font-weight: bold; font-size: 25px">EL DATACRÉDITO ESTA VENCIDO</span></span></a>';
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (row.AutorizacionGerente == 0) {
                            ...
                            var editButton =
                                `<div class="text-center fw-bold fs-2">Notificar a Coordinación</div>`;
                        } else {
                            var editButton =
