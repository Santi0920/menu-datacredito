              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <a href="registrarpagaredir"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="font-size:25px;"></button></a>
                  </div>
                  <div class="modal-body">
                    <form action="{{route('cruddir.generarpdf')}}" method="POST">
                      @csrf
                      <div class="mb-3">
                  ...
                  <div class="modal-footer">
                    <a href="registrarpagaredir"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="font-size:20px; font-weight: bold">CERRAR</button></a>
