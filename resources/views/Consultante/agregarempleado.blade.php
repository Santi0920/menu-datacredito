...
.formato-ayuda {
  ...
  <p class="formato-ayuda">Si la persona no tiene Autorización, ingresar N/A(No aplica).</p>
</div>
...
<div class="mb-3 w-100">
    <label for="exampleInputEmail1" class="form-label fw-semibold">ADJUNTAR CÉDULA <span class="text-danger" style="font-size:20px;">*</span></label>
    <input type="file" class="form-control" name="contrato" id="contrato" required>
    <p class="formato-ayuda2">Debe contener el formato: <strong>(No.Cédula).pdf</strong><br><span style="font-size: 22px"><strong>Ejemplo: 10054782.pdf</strong></span></p>
  </div>
...
consecutivofInput.setAttribute("maxlength", "6");
    ...
    if (!/^[0-9]+$/.test(InspektorInput.value)) {   
      Swal.fire({
        icon: 'error',
        title: '¡Error!',
        text: 'El campo INSPEKTOR debe contener solo registros numéricos!',
        confirmButtonColor: '#005E56'
      });
      window.scrollTo({ top: 0, behavior: 'smooth' });
      Inspektorrror2.textContent = '';
      InspektorInput.focus();
      return false;
    }
        return true;
      }
...
function toggleCheckbox() {
    var checkbox = document.getElementById("Tipoasociado");
    ...
    <div class="modal fade" id="modalEditar_${id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="label" id="" class="form-label fw-bold" style="margin-left: -66%;">ADJUNTAR CÉDULA</label>
                  <input type="file" class="form-control" name="contrato1" id="contrato1" accept="application/pdf" value="${row.NombreContrato}">
                  <p class="formato-ayuda2">Debe contener el formato: <strong>(Cédula).pdf</strong></strong></p>
                  </div>
              ...
              <div class="mb-3 w-100 text-start" title="">
                    <input type="checkbox" id="Tipoasociado" name="Consulta" value="1" style="width: 25px; height: 20px;">
                    <label for="Consulta" class="fw-semibold" style="font-size: 25px" onclick="toggleCheckbox2()">REALIZAR CONSULTA</label>
                </div>

                <div class="mb-3 w-100 text-start" title="">
                    <input type="checkbox" id="Tipoasociado" name="Tipoasociado" value="1" style="width: 25px; height: 20px;">
                    <label for="Consulta" class="fw-semibold" style="font-size: 25px" onclick="toggleCheckbox2()">CONTRATO INDEFINIDO</label>
                </div>
