  ...
  <ul class="navbar-nav me-auto mb-lg-0 header">        
      ...
      <div class="dropdown nav-item">
        ...
        <li class="dropdown-toggle text-white text-start" style=" list-style-type: none; font-size: 25px" ><a class="fw-semibold text-white" style=" font-size: 25px; text-decoration: none; margin-left: -17px">Solicitud Datacrédito</a></li>
            ...
            <ul class="dropdown-menu" style="background-color: #005E56;">
              <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="nuevosempleados">Nuevos Empleados</a></li>
              <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="proveedortah">Proveedores y Terceros</a></li>
              <ul class="dropend">
              <li class="dropdown-toggle text-white text-start" style=" list-style-type: none; font-size: 25px" ><a class="fw-semibold text-white" style=" font-size: 25px; text-decoration: none; margin-left: -17px">Consultar</a></li>
                  <ul class="dropdown-menu" style="background-color: #005E56;">
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="nuevosempleadosconsultar">Nuevos Empleados</a></li>
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="consultarprovtah">Proveedores y Terceros</a></li>
                  </ul>
              </ul></li>            
            </ul>
        </ul>
