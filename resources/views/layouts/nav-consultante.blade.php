                        ...
                        <ul class="dropend">
                            <li class="dropdown-toggle text-white text-start"
                                style=" list-style-type: none; font-size: 25px"><a class="fw-semibold text-white"
                                    style=" font-size: 25px; text-decoration: none; margin-left: -17px">Solicitud
                                    Datacrédito</a></li>

                            <ul class="dropdown-menu" style="background-color: #005E56;">

                                <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
                                        href="director">Asociación</a></li>

                                <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
                                        href="directorcredito">Crédito</a></li>
                                <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
                                        href="directorempleado">Empleados Nuevos</a></li>
                                <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
                                        href="directorproveedor">Proveedores y Terceros</a></li>
                                <ul class="dropend">
                                    <li class="dropdown-toggle text-white text-start"
                                        style=" list-style-type: none; font-size: 25px"><a
                                            class="fw-semibold text-white"
                                            style=" font-size: 25px; text-decoration: none; margin-left: -17px">Consultar</a>
                                    </li>
                                    <ul class="dropdown-menu" style="background-color: #005E56;">
                                        <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
                                                href="{{ route('consultante.listar') }}">Asociados</a></li>
                                        <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
                                                href="consultarcredito">Crédito</a></li>
                                        <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px"
