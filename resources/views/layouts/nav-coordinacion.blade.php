...
<nav class="navbar navbar-expand-lg bg-body-secondary p-0" id="Menu">
    <div class="container-fluid menu-bar" style="">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!-- Foto Coopserp-->
            <img src="img/CoopserpPH.png" alt="Coopserp.icono" width="150px" height="60px" id="data"
                class="navbar-brand mb-2 mt-2" style="filter: drop-shadow(0 2px 0.8px white);">
            ...
            <ul class="navbar-nav me-auto mb-lg-0 header">
                ...
                <div class="dropdown nav-item">
                    @if (auth()->user() &&
                        ...
                        <li class="nav-link active text-white dropdown-toggle fw-bold" type="button"
                            data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 25px">
                            Datacrédito
                        </li>
                        <ul class="dropdown-menu" style="background-color: #005E56;">
                            <ul class="dropend">
                                <li class="dropdown-toggle text-white text-start"
                                    style=" list-style-type: none; font-size: 25px"><a class="fw-semibold text-white"
                                        style=" font-size: 25px; text-decoration: none; text-aling:start; margin-left: -20px">Solicitud
                                        Datacrédito</a></li>

                                <ul class="dropdown-menu" style="background-color: #005E56;">
                                    <li class="text-center"><a class="text-center text-white dropdown-item fw-semibold "
                                            style="font-size: 25px" href="coordinacion">Proveedores y Terceros</a></li>
                                    <li class="text-center"><a class="text-center text-white dropdown-item fw-semibold "
                                            style="font-size: 25px" href="consultarprovc">Consultar Proveedores y
                                            Terceros</a></li>
                                </ul>
                            </ul>
                    @endif
                    @if (auth()->user() && auth()->user()->agenciau == 'Coordinacion 6')
                        ...
                        <ul class="dropdown-menu" style="background-color: #005E56;">
                            <ul class="dropend">
                                ...
                                <ul class="dropdown-menu" style="background-color: #005E56;">
                                    <li class="text-center"><a class="text-center text-white dropdown-item fw-semibold "
                                            style="font-size: 25px; cursor: not-allowed" href="#">Proveedores y
                                            Terceros</a></li>
                                    <li class="text-center"><a class="text-center text-white dropdown-item fw-semibold "
                                            style="font-size: 25px; cursor: not-allowed" href="#">Consultar
                                            Proveedores y Terceros</a></li>
                                </ul>
                            </ul>
                    @endif
                </div>
                ...
                <div class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu" style="background-color: #005E56;">
                            ...
                            @if (auth()->user() && auth()->user()->agenciau == 'Coordinacion 6')
                                <ul class="dropend">
                                    <li class="dropdown-toggle text-white text-start"
                                        style=" list-style-type: none; font-size: 25px"><a
                                            class="fw-semibold text-white"
                                            style=" font-size: 25px; text-decoration: none; text-aling:start; margin-left: -60px">Registros
                                            Pagare</a></li>

                                    <ul class="dropdown-menu" style="background-color: #005E56;">
                                        <li class="text-center"><a
                                                class="text-center text-white dropdown-item fw-semibold "
                                                style="font-size: 25px" href="registrarpagare"><i
                                                    class="fa-solid fa-qrcode"></i> Escanear Pagare</a></li>
                                        <li class="text-white dropdown-divider"></li>
                                        <li class="text-center"><a
                                                class="text-center text-white dropdown-item fw-semibold "
                                                style="font-size: 25px" href="registrarpagareordinario"><i
                                                    class="fa-solid fa-qrcode"></i> Pagaré Único</a></li>
                                        <li class="text-white dropdown-divider"></li>
                                        <li class="text-center"><a
                                                class="text-center text-white dropdown-item fw-semibold "
                                                style="font-size: 25px" href="pagarecorreos"><i
                                                    class="fa-solid fa-qrcode"></i> Listar Pagarés</a></li>
                                        <li class="text-white dropdown-divider"></li>
                                        <li class="text-center"><a
                                                class="text-center text-white dropdown-item fw-semibold "
                                                style="font-size: 25px" href="coorpagarefiltrar"><img
                                                    src="img/pdf.png" style="height: 2.0rem;"> Generar PDF</a></li>
                            @endif
                            @if (auth()->user() &&
                                    in_array(auth()->user()->agenciau, [
                                        'Coordinacion 1',
            ...
            <span class="mx-4 text-white" style="font-size: 25px;"><img style="height: 2.5rem" class="mx-1"
                    src="img/perfil.png">Bienvenid@ <strong>{{ auth()->user()->name }}</strong></span>
            ...
            <ul class="navbar-nav mb-lg-0 me-2">
                <li class="nav-item dropdown w-25" data-bs-theme="light">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end px-1" style="background-color: #005E56;"
                        aria-labelledby="bd-theme">
                        <li>
                            <button type="button" class="dropdown-item d-flex align-items-center text-white fw-bold"
            ...
            <a onclick="return csesion()" href="{{ route('login.destroy') }}"><button class="btn btn-light"><b
                        style="font-size: 25px;">Cerrar Sesión</b></button></a>
