  ...
  <ul class="navbar-nav me-auto mb-lg-0 header">
      ...
      <div class="dropdown nav-item">
        ...
        <li class="dropdown-toggle text-white text-start" style=" list-style-type: none; font-size: 25px" ><a class="fw-semibold text-white" style=" font-size: 25px; text-decoration: none; margin-left: -17px">Solicitud Datacrédito</a></li>
            ...
            <ul class="dropdown-menu" style="background-color: #005E56;">
            <li class="text-center"><a class="text-center text-white dropdown-item fw-semibold " style="font-size: 25px" href="controlmasivoproveedor">Proveedores y Terceros</a></li>
          <li class="text-center"><a class="text-center text-white dropdown-item fw-semibold " style="font-size: 25px" href="consultarproveedormas">Consultar Proveedores y Terceros</a></li>
              <ul class="dropend">
              <li class="dropdown-toggle text-white text-start" style=" list-style-type: none; font-size: 25px" ><a class="fw-semibold text-white" style=" font-size: 25px; text-decoration: none; margin-left: -17px">Control</a></li>
                  <ul class="dropdown-menu" style="background-color: #005E56;">
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="controlmasivo">Asociación</a></li>
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="creditocontrolmasivo">Crédito</a></li>
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="empleadocontrolmasivo">Empleados</a></li>
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="proveedorcontrolmasivo">Proveedores y Terceros</a></li>
                    <li><a class="text-white dropdown-item fw-semibold" style="font-size: 25px" href="avirtualcontrolmasivo">Asociacion Virtual</a></li>
