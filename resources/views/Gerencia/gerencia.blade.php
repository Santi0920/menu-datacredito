...
<form action="{{route('crudger.createproveedor')}}" class="col 3 m-3" method="POST" enctype= "multipart/form-data" onsubmit="return validateForm()">
...
<div class="mb-3 w-100">
    ...
    <p class="formato-ayuda2">Debe contener el formato: <strong>Autorizacion-(Cédula).pdf o Autorizacion-(NIT).pdf</strong></strong></p>
  </div>
  ...
  <input type="text" class="form-control" name="consecutivoa" id="consecutivoa" value="" required autocomplete="off" maxlength="19">
...
{data: 'Observaciones'},
    {    data: null,
      render: function(data, type, row) {
        ...
        var url = "{{ route('crudger.update', ':id') }}";
...
if(row.Consulta == 1){
    ...
    <label for="Consulta" class="fw-semibold" style="font-size: 25px" onclick="toggleCheckbox()">SOLICITAR CONSULTA</label>
      ...
      var editButton = `<a href="" id="modalLink_${id}" type="submit" class="btn btn-small btn-warning edit-button edit" data-bs-toggle="modal" data-bs-target="#modalEditar_${id}" data-id="${id}" style="margin-right: "><i class="fa-regular fa-pen-to-square"></i></a>
              ...
              <div class="mb-3">
                  ...
                  <input list="agencia" type="text" class="form-control" id="agencia3" name="agencia3" value="${row.Agencia}" maxlength="20" autocomplete="off" readonly style="background-color: #EBEBEB; cursor: not-allowed;">
                  <div id="agenciaError3" style="color: red;" class="fw-bold"></div>
              </div>

              <div class="mb-3">
                  <label for="click" id="" style="margin-left: -53%" class="form-label fw-bold">VALOR COMPRA | SERVICIO</label>
        ...
        <div class="modal-body">
          <form action="${url}" class="text-center" method="POST" enctype="multipart/form-data" id="formulario" onsubmit="return validateFormNuevo()">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                  <label for="click" id="izquierda7" class="form-label fw-bold">AGENCIA</label>
                  <input list="agencia" type="text" class="form-control" id="agencia4" name="agencia4" value="${row.Agencia}" maxlength="20" autocomplete="off" readonly style="background-color: #EBEBEB; cursor: not-allowed;">
                  <div id="agenciaError3" style="color: red;" class="fw-bold"></div>
              </div>
  ...
  "language": {
    ...
    "zeroRecords": "<span style='font-size: 40px; text-align: left;'>No existe!</span>",
