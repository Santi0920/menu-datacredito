...
<form action="{{route('crudjefa.createproveedor')}}" class="col 3 m-3" method="POST" enctype= "multipart/form-data" onsubmit="return validateForm()">
...
return true;
 ...
 var table = $('#personas').DataTable({
  "ajax": "{{ route('datatable.proveedorjefa') }}",
  "columns": [
    {
      data: null,
      title: '#',
...
{data: 'Observaciones'},
    {    data: null,
      render: function(data, type, row) {
        ...
        var url = "{{ route('crudjef.update', ':id') }}";
