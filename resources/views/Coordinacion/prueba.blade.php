    ...
    {    data: null,
      render: function(data, type, row) {
        ...
        if(row.CorreoEnviado == 0){
          if(row.ExisteDatacredito == 1 || row.ExisteDatacredito == 2){
            var RechazadoButton = '';
            return RechazadoButton;
          }
          else if(row.Aprobado == 1){
            var AprobadoButton = '<a onclick="return eliminar2()" href="{{ route('crud.pagarecorreo', ':id') }}" type="submit" class="btn btn-small btn-warning fs-4" name="eliminar" value="ok"><i class="fa-solid fa-check"></i></a>'.replace(':id', row.ID);
            return AprobadoButton;
          }else if(row.Aprobado == 0){
            var RechazadoButton = '<a onclick="return eliminar2()" href="{{ route('crud.pagarecorreorecha', ':id') }}" type="submit" class="btn btn-small btn-danger fs-4" name="eliminar" value="ok"><i class="fa-solid fa-x"></i></a>'.replace(':id', row.ID);
            return RechazadoButton;
          }
        }else {
          if(row.ExisteDatacredito == 1 || row.ExisteDatacredito == 2){
            ...
            var AprobadoButton = '<a onclick="return false;" title="CORREO YA FUE ENVIADO!" class="btn btn-small btn-warning fs-4 disabled-link" name="eliminar" value="ok" disabled><i class="fa-solid fa-check"></i></a>'.replace(':id', row.ID);
            return AprobadoButton;
          }else if(row.Aprobado == 0){
            var RechazadoButton = '<a onclick="" type="submit" class="btn btn-small btn-danger fs-4 disabled-link" name="eliminar" value="ok"><i class="fa-solid fa-x"></i></a>'.replace(':id', row.ID);
            return RechazadoButton;
          }
        }
}
  ...
  },
{
  ...
  "initComplete": function(settings, json) {
    var buttonsHtml = '<div class="custom-buttons">' +
          '<button id="btnT" class="custom-btn" title="RECARGAR INFORMACIÓN"><i class="fa-solid fa-rotate-right"></i></button>' +
