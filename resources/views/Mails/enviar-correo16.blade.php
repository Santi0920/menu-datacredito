...
<body>
    ...
    <div class="container">
        ...
        <div style="font-weight: bold">
            ...
            <h1>Score: {{$score}} - Consulta: {{$fechaconsulta}}</h1>
        </div>

        <p style="color: black; text-align: justify;">Buen día, se informa que se <strong>APROBÓ</strong> el crédito del pagaré vinculado al asociado: <strong>{{$nombrepagare}}</strong> con CC. <strong>{{$cedula}}</strong>.
            <br><span style="font-size: 20px; text-align: center">Consecutivo #{{$idposicionpagare}}</span>
        </p>
    </div>
    <div class="footer">
