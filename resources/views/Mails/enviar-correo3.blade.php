...
<body>
    ...
    <div class="container">
        ...
        <p style="color: black; text-align: justify;">Buen día, se informa que puede generar la consulta a nombre de: <strong>{{ $nombreUsuario }}</strong> con cc.<strong>{{$cedula}}</strong>.<br>Recibo de Caja: <strong>{{$recibo}}</strong>.
        </p>
    </div>
    <div class="footer">
