...
<body>
    ...
    <div class="container">
        ...
        <p style="color: black; text-align: justify;">Buen día, se informa que {{$tipo}} con Razón Social <strong>{{ $razon }} </strong>con NIT # <strong>{{ $nit }}</strong> fue cambiado por un Generador de Consulta<strong>{{$talento}}</strong>. 
