...
<body>
    ...
    <div class="container">
        ...
        <p style="color: black; text-align: justify;">Buen día, se informa que {{$tipo}} <strong>{{ $nombreUsuario }} </strong>con cédula cc.<strong>{{ $cedula }}</strong> fue cambiado por un Generador de Consulta<strong>{{$talento}}</strong>. 
