...
<body>
    ...
    <div class="container">
        ...
        <p style="color: black; text-align: justify;">Buen día, se informa que {{$tipo}} <strong>{{ $nombreUsuario }} </strong>con cédula cc.<strong>{{ $cedula }}</strong> fue cambiado por un Generador de Consulta-CRÉDITO. 
            <br><span style="font-size: 20px">Ya es <strong>VISIBLE</strong> el registro en su interfaz de Crédito.</span>
        </p>
    </div>
    <div class="footer">
