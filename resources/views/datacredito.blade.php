...
@endif
    ...
    <form action="" class="text-center" id="" method="POST" enctype="multipart/form-data">
        <div class="container">
             <div class="agregar">
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                ...
                <button type="button" data-bs-dismiss="modal" class="btn-close p-3" aria-label="Close"></button>
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
                        ...
                        <h1 class="modal-title text-center fw-semibold" id="modificar">CONSULTANTE</h1>
                    ...
                    <form action="" method="post">
                      ...
                      <input type="hidden" name="campo3" id="campo3" class="form-control w-50 filtrar mb-4">
                    </form> 
                ...
                <!--Label1-->  
                <div class="mb-3">
                    <label for="label" id="consul1" class="form-label fw-bold" value="">NOMBRE DE USUARIO</label>
                    <input type="text" class="form-control" name="username" id="username" >
                    <div id="usernameError" style="color: red;" class="fw-bold"></div>
                </div>
                ...
                usernameInput.addEventListener('keyup', function() {
                  ...
                  if (/^[a-zA-Z0-9]{1,20}$/.test(username)) {
                    ...
                    usernameError.innerHTML = 'El nombre de usuario solo debe contener letras y números';
                  }
                });
                ...
                <div class="mb-3">
                    ...
                    <div id="correoError" style="color: red;" class="fw-bold"></div>
                </div>
                <script>
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" id="consul3" class="form-label fw-semibold">CONTRASEÑA</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="ccontraseña" id="ccontraseña" >
                    <div id="ccontraseñaError" style="color: red;" class="fw-bold"></div>
                    <div id="ccontraseñaSucces" style="color: green;" class="fw-bold"></div>
                </div>
                <script>
                  var ccontraseñaInput = document.getElementById('ccontraseña');
            ...
            <button  type="submit" class=" btn btn-primary w-50" name="btnregistrar2" value="ok" style="background-color: #005E56;">Registrar</button>
            </div>
        ...
        <table id="personas" class="hover table table-responsive table-striped shadow-lg mt-4 table-bordered table-hover"  style="width:100%" >
          ...
          <tbody class="table-group-divider">
            @foreach($datos as $item)
              <tr>
                ...
                <td><a href="" type="submit" class="btn btn-small btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditar"><input type="hidden" name=""><i class="fa-regular fa-pen-to-square"></i></a>
          ...
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              ...
              <div class="mb-3">
                ...
                <td><a onclick="return eliminar()" href="{{route("crud.delete",$item->ID)}}" type="submit" class="btn btn-small btn-danger" name="eliminar" value="ok"><i class="fa-solid fa-trash"></i></a></td>
