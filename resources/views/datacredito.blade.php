...
consecutivofInput.setAttribute("maxlength", "6");
    ...
    <div style="overflow: auto;">
        ...
        <div class="modal fade" id="modalEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <form action="" class="text-center" method="POST" enctype="multipart/form-data" onsubmit="return validateForm2()">
                @csrf
              <!--Label1-->  
              <div class="mb-3">
                  <label for="cedula2" id="izquierda7" class="form-label fw-bold" value="">CÉDULA</label>
                  <input type="text" class="form-control" name="cedula2" readonly value="" style="background-color: #EBEBEB;">
                  <input type="hidden" name="cedula3" value="">
              </div>
  
              <div class="mb-3">
                <label for="nombre3" id="izquierda3" class="form-label fw-bold">NOMBRE</label>
                <input type="text" class="form-control" id="nombre3" name="nombre3" value="" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="apellidos3" name="apellidos3" value="" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="score3" name="score3" value="" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="reporte3" name="reporte3" value="">
              ...
              <div class="mb-3 ">
                  ...
                  <input type="text" class="form-control" name="cuenta3" readonly value="" style="background-color: #EBEBEB;">
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="agencia3" name="agencia3" value="" required>
              ...
              <div class="mb-3">
                  ...
                  <input type="date" class="form-control" name="fecha3" id="fecha3" min="2022-08-01" max="" value="" required>
                </div>
              ...
              <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="file" class="form-control" name="archivo33" accept="application/pdf" value="">
                </div> --}}
              
                <div class="mb-3 w-100">
                  <label for="exampleInputEmail1" id="izquierda11" class="form-label fw-bold">CONSECUTIVO FORMATO</label>
                  <input type="text" class="form-control " name="consecutivof3" id="consecutivof" readonly value="" style="background-color: #EBEBEB;">
...
$('#personas').DataTable({
  ...
  render: function(data, type, row) {
    ...
    {    data: null,
      render: function(data, type, row) {
  var deleteButton = '<a onclick="return eliminar()" href="{{ route('crud.delete', ':id') }}" type="submit" class="btn btn-small btn-danger" name="eliminar" value="ok"><i class="fa-solid fa-trash"></i></a>'.replace(':id', row.ID);
  var editButton = '<a href="" type="submit" class="btn btn-small btn-warning edit-button" data-bs-toggle="modal" data-bs-target="#modalEditar" style="margin-right: "><i class="fa-regular fa-pen-to-square"></i></a>';
...
$(document).on('click', '.edit-button', function(e) {
  ...
  // Realiza la consulta Ajax para obtener los datos del registro
  $.ajax({
    url: '{{ route('crud.update', ':id') }}',
    type: 'GET',
    dataType: 'json',
    success: function(response) {
      // Manipula los datos de respuesta y actualiza los campos del formulario modal
      $('#cedula2').val(response.cedula);
