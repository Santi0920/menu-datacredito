...
@include('layouts/nav-controlmasivo')
    ...
    <h2 class="p-2 mb-0 text-secondary text-start"><b>Asociación Virtual - <span class="text-end" id="fechaActual"></b></span></h2>
    <script>
 ...
 var table = $('#personas').DataTable({
  "ajax": "{{ route('datatableavirtual.controlmasivo') }}",
  "columns": [
    {
      data: null,
      title: '#',
