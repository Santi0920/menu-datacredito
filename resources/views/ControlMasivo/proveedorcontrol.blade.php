  ...
  render: function(data, type, row) {
    if (type === 'display') {
      if (data === null) {
        ...
        return '<a href="Storage/files/rc/' + data + '" target="__blank"><img src="img/pdf.png" title="'+data+'" style="height: 2.5rem"></a><span class="d-none fw-bold blink" style="font-size: 20px;"><br>1</span>';
      }
    }
    return data;
  }
  ...
  render: function(data, type, row) {
    if (type === 'display') {
      if (data === null) {
        ...
        return '<a href="Storage/files/sintesis/' + data + '" target="__blank"><img src="img/pdf.png" title="'+data+'" style="height: 2.5rem"></a><span class="d-none fw-bold blink" style="font-size: 20px;"><br>1</span>';
      }
    }
    return data;
  }
