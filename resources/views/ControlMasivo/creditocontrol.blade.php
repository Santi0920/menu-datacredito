  ...
  render: function(data, type, row) {
    if (type === 'display') {
      if (data === 'null.html' || data === null) {
        ...
        return '<a href="Storage/files/sintesis/' + data + '" target="__blank"><img src="img/pdf.png" style="height: 2.5rem"></a><br><span class="d-none">1</span>';
      }
    }
    return data;
  }
  ...
  render: function(data, type, row) {
    if (type === 'display') {
      if (data === 'null.html' || data === null) {
        ...
        return '<a href="Storage/files/pn/' + data + '" target="__blank"><img src="img/pdf.png" style="height: 2.5rem"></a><br><span class="d-none">1</span>';
      }
    }
    return data;
  }
...
{data: 'NombreA',
      "render": function(data, type, row) {
        if (type === 'display') {
          ...
          return '<a href="Storage/files/autorizacion/' + data + '" target="__blank"><img src="img/pdf.png" style="height: 2.5rem"></a><br><span class="d-none">1</span>';
          }
        }
        return data;
      }
  ...
  render: function(data, type, row) {
    if (type === 'display') {
      if (data === 'null.html' || data === null) {
        ...
        return '<a href="Storage/files/rccreditos/' + data + '" target="__blank"><img src="img/pdf.png" style="height: 2.5rem"></a><br><span class="d-none">1</span>';
      }
    }
    return data;
  }
