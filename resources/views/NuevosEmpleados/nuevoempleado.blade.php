...
@include('layouts/nav-nuevosempleados')
...
<form action="{{route('crudnuevo.create')}}" class="col 3 m-3" method="POST" enctype= "multipart/form-data" onsubmit="return validateForm()">
...
return true;
 ...
 var table = $('#personas').DataTable({
  "ajax": "{{ route('datatable.nuevoempleado') }}",
  "columns": [
    {
      data: null,
      title: '#',
...
function toggleCheckbox() {
    ...
    <div class="modal fade" id="modalEditar_${id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="mb-3">
                  ...
                  <input type="file" class="form-control" name="archivo3" id="archivo3" accept="application/pdf" value="${row.NombreA}" required>
                  <p class="formato-ayuda2">Debe contener el formato: <strong>Autorizacion-(Cédula).pdf</strong></strong></p>
                  </div>
                     
                  <div class="mb-3">
  <label for="label" id="izquierda11" class="form-label fw-bold" style="margin-left: -48%;">CONSECUTIVO AUTORIZACIÓN</label>
  <input type="text" class="form-control" name="consecutivof33" id="consecutivof33" value="${row.ConsecutivoA}" required maxlength="8">
